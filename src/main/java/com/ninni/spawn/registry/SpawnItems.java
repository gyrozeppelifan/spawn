...
public class SpawnItems {
    ...
    // angler fish
    public static final Item ANGLER_FISH_SPAWN_EGG = register("angler_fish_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnFish.ANGLER_FISH, 0x2A3327, 0x95D930, new Item.Properties()));
    public static final Item ANGLER_FISH_BUCKET = register("angler_fish_bucket", new MobBucketItem(SpawnEntityType.SpawnFish.ANGLER_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1)));
    ...
    // tuna
    public static final Item TUNA_SPAWN_EGG = register("tuna_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnFish.TUNA, 0x4572B3, 0xE9B936, new Item.Properties()));
    ...
    public static final Item TUNA_EGG_BUCKET = register("tuna_egg_bucket", new MobBucketItem(SpawnEntityType.SpawnFish.TUNA_EGG, Fluids.WATER, SpawnSoundEvents.BUCKET_EMPTY_TUNA_EGG, new Item.Properties().stacksTo(1)));

    // seahorse
    public static final Item SEAHORSE_SPAWN_EGG = register("seahorse_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnFish.SEAHORSE, 0xFBC738, 0xFFFFFF, new Item.Properties()));
    public static final Item SEAHORSE_BUCKET = register("seahorse_bucket", new MobBucketItem(SpawnEntityType.SpawnFish.SEAHORSE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1)));

    // snail
    public static final Item SNAIL_SPAWN_EGG = register("snail_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnLandCreature.SNAIL, 0x5D3F30, 0xF6DEA2, new Item.Properties()));
    ...
    // hamster
    public static final Item HAMSTER_SPAWN_EGG = register("hamster_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnLandCreature.HAMSTER, 0x92816C, 0xFFFFFF, new Item.Properties()));
    // sunflowers
    ...
    // ant
    public static final Item ANT_SPAWN_EGG = register("ant_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnLandCreature.ANT, 0x3C3436, 0x282527, new Item.Properties()));
    // ant blocks
    ...
    public static final Item CLAM_SPAWN_EGG = register("clam_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnAquaticCreature.CLAM, 0xB9776B, 0xEAC6AB, new Item.Properties()));
    ...
    // sea cow
    public static final Item SEA_COW_SPAWN_EGG = register("sea_cow_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnAquaticCreature.SEA_COW, 0x696969, 0x7C7C7C, new Item.Properties()));
    ...
    // octopus
    public static final Item OCTOPUS_SPAWN_EGG = register("octopus_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnCephalopod.OCTOPUS, 0xB51C65, 0xFFBE2B, new Item.Properties()));
    ...
    // sea lion
    public static final Item SEA_LION_SPAWN_EGG = register("sea_lion_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnAquaticCreature.SEA_LION, 0x5E4834, 0xC08650, new Item.Properties()));

    // sunfish
    public static final Item SUNFISH_SPAWN_EGG = register("sunfish_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnFish.SUNFISH, 0x576276, 0x91A6BE, new Item.Properties()));
    public static final Item BABY_SUNFISH_BUCKET = register("baby_sunfish_bucket", new MobBucketItem(SpawnEntityType.SpawnFish.SUNFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1)));

    // herring
    public static final Item HERRING_SPAWN_EGG = register("herring_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnFish.HERRING, 0x1051AD, 0xCACACA, new Item.Properties()));
    public static final Item HERRING_BUCKET = register("herring_bucket", new MobBucketItem(SpawnEntityType.SpawnFish.HERRING, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1)));
    ...
    // whale
    public static final Item WHALE_SPAWN_EGG = register("whale_spawn_egg", new SpawnEggItem(SpawnEntityType.SpawnAquaticCreature.WHALE, 0x3C4A56, 0xD1D3D3, new Item.Properties()));
