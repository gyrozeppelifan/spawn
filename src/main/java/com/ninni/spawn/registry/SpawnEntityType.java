...
public class SpawnEntityType {
    ...
    static {
        ...
        BiomeModifications.addSpawn(BiomeSelectors.tag(SpawnTags.TUNA_SPAWNS), MobCategory.WATER_CREATURE, SpawnEntityType.TUNA, 15, 1, 3);
        ...
        BiomeModifications.addSpawn(BiomeSelectors.tag(SpawnTags.SEA_COW_SPAWNS), MobCategory.WATER_CREATURE, SpawnEntityType.SEA_COW, 20, 1, 3);
        ...
        BiomeModifications.addSpawn(BiomeSelectors.tag(SpawnTags.HAMSTER_FREQUENTLY_SPAWNS), MobCategory.CREATURE, SpawnEntityType.HAMSTER, 50, 1, 4);
    }
